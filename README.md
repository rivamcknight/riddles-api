...
- [API documentation using Swagger UI](https://guarded-eyrie-88809.herokuapp.com/api-docs)
  ...
  <a href="https://guarded-eyrie-88809.herokuapp.com/api-docs"><img src="public/images/swagger.png?raw=true" alt="Swagger UI screenshot" width="400"/></a>
- [API documentation using Stoplight](https://rmcknight.stoplight.io/docs/riddles-api)

  <a href="https://rmcknight.stoplight.io/docs/riddles-api"><img src="public/images/stoplight.png?raw=true" alt="Stoplight.io screenshot" width="400"/></a>
- [API documentation using Markdown](#riddles-api-documentation)

  <a href="#riddles-api-documentation"><img src="public/images/markdown.png?raw=true" alt="Markdown screenshot" width="400"/></a>
